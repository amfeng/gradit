class Word < ActiveRecord::Base
  ...
  def choices
	...
	if (mc.is_intersection) 
	  MultipleChoice.create(:word_id => self.id, :is_intersection => false, :intersection_id => nil, :choice1 => mclist[0], :choice2 => mclist[1], :choice3 => mclist[2], :choice4 => mclist[3], :score => 20)
	end
	return mclist
  end    
end
